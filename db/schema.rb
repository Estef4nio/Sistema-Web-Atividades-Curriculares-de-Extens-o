...
ActiveRecord::Schema.define(version: 2023_11_22_225929) do
  ...
  create_table "requis", force: :cascade do |t|
    t.string "titulo"
  ...
  create_table "requisicos", force: :cascade do |t|
    t.string "titulo"
    t.integer "users_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["users_id"], name: "index_requisicos_on_users_id"
  end
  ...
  add_foreign_key "requis", "atividades"
  add_foreign_key "requis", "modalidades"
  add_foreign_key "requis", "users"
  add_foreign_key "requisicos", "users", column: "users_id"
end
