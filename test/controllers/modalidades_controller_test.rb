...
class ModalidadesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create modalidade" do
    assert_difference("Modalidade.count") do
      post modalidades_url, params: { modalidade: { cargaHoraria: @modalidade.cargaHoraria, nome: @modalidade.nome } }
    end
  ...
  test "should update modalidade" do
    patch modalidade_url(@modalidade), params: { modalidade: { cargaHoraria: @modalidade.cargaHoraria, nome: @modalidade.nome } }
