...
class AtividadesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create atividade" do
    assert_difference("Atividade.count") do
      post atividades_url, params: { atividade: { cargaHorariaMaxima: @atividade.cargaHorariaMaxima, nome: @atividade.nome } }
    end
  ...
  test "should update atividade" do
    patch atividade_url(@atividade), params: { atividade: { cargaHorariaMaxima: @atividade.cargaHorariaMaxima, nome: @atividade.nome } }
